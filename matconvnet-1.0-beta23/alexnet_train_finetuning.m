function [net, info] = alexnet_train_finetuning(imdb,expDir, varargin)
	...
	opts.train.gpus = [] ;
	opts.train.learningRate = [1e-2*ones(1, 10),  1e-3*ones(1, 5)];
	...
	net.addLayer('conv2', dagnn.Conv('size', [5 5 96 256], 'hasBias', true, 'stride', [1, 1], 'pad', [2 2 2 2]), {'pool1'}, {'conv2'},  {'conv2f'  'conv2b'});
